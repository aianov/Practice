...
ПРИВЕТ! Я не знаю что ты тут забыл но спасибо что попал сюда и смотришь этот код. данный файл или данная папка js arrays просто моя тренировка и практика на пути становления к junior frontend разработчику. на сегодняшнем уроке я изучил (изучаю на данный момент) вот такие функции для массивов. ну чтож я пошел учиться      13:08 - 11.02.2023
